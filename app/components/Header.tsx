export default function Header() {
    return (
      ...
      <div className="flex items-start pt-0 pb-[16px] px-[112px] relative bg-white border-b [border-bottom-style:solid] border-[#4040404c]">
        <div className="flex w-[1920px] h-[30px] items-center justify-between pl-[10px] pr-[12.02px] pt-[20px] pb-0 relative mr-[-112.00px]">
